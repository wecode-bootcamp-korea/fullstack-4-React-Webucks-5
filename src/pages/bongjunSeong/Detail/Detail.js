      ...
      <div className="container">
        ...
        <section>
          <div className="sectionTop">
            ...
            <p className="menuLine">홈 &#62; MENU &#62; 음료 &#62; 콜드 브루 커피 &#62; 바닐라 크림 콜드 브루</p>
          </div>
          <article>
            <div className="divImg"><img className="coffeeImg" src="./images/bongjunSeong/example.jpg" alt="커피" /></div>
            <div className="sectionRight">
              <div className="coffeeBox">
                ...
                <div className="heart gray"><i id="icon" className="fa-regular fa-heart gray"></i></div>
              </div>
              <div className="explain">콜드 브루에 더해진 바닐라 크림으로 깔끔하면서 달콤한 콜드 브루를 새롭게 즐길 수 있는 음료입니다.</div>
              <div className="ingredients">
                ...
                <div className="inBottom"><p>알레르기 유발요인 : 우유</p></div>
                <div className="review">
                  <div className="reviewTitle"><p>리뷰</p></div>
                  <div className="reviewList">
                    <div className="reviewLine">
                      <p><strong>coffee_lover</strong> 너무 맛있어요!</p>
                      <i className="fa-regular fa-heart gray"></i>
                      <i className="fa-regular fa-trash-can gray"></i>
                    </div>
                    <div className="reviewLine">
                      <p><strong>CHOCO7</strong> 오늘도 바크콜 마시러 갑니다.</p>
                      <i className="fa-regular fa-heart gray"></i>
                      <i className="fa-regular fa-trash-can gray"></i>
                    </div>
                    <div className="reviewLine">
                      <p><strong>legend_dev</strong> 진짜 바닐라 크림 콜드 브루는 전설이다.</p>
                      <i className="fa-regular fa-heart gray"></i>
                      <i className="fa-regular fa-trash-can gray"></i>
                    </div>
                  </div>
                  <input className="reviewChat" type="text" placeholder="리뷰를 입력해주세요."></input>
                </div>
              </div>
            </div>
          </article>
